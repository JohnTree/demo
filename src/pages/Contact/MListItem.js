/**
 * Created by wangshiyang on 2017/3/4.
 */
...
const ListItem = ({
    ...
    console.warn(imgStr,selectState)
                ...
                </View>
                {
                    rightTitle && (rightTitle !== '') && (
                        <View style={[styles.rightTitleContainer, rightTitleContainerStyle]}>
                            <Image
                                style={[styles.rightImgStyle, rightTitleStyle]}
                                source={imgStr?{uri:selectState?imgStr:FS+rightTitle}:require('../../../imgs/pic_my_nophoto@3x.png')}
                            />
                        </View>
                    )
                }
