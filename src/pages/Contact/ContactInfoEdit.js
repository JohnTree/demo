...
export default class ContactInfoEdit extends React.Component {
    ...
    submits() {
        ...
        if (this.props.keyValue == "mctName") {
            Ajax("CmgInfoRemakeController/updConcatInfo.do",
                {"conName": this.state.textValue}).then(v => {
                if (true === v.success) {
            ...
            Ajax("MctTradeRemarkController/updMctInfo.do",
                {"conPhone": this.state.textValue}).then(v => {
                if (true === v.success) {
            ...
            Ajax("MctTradeRemarkController/updMctInfo.do",
                {"oldPhone": this.state.textValue}).then(v => {
                if (true === v.success) {
