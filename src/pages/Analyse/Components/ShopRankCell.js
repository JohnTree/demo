...
export default class ShopRankCell extends React.Component {
    ...
    constructor(props) {
        super(props);
        var {rank, mctLogoUrl, mctName, orderNum,mctId,levelId} = this.props;
        this.state = {
     ...
     */
    render() {
        var {index,rankImg, name, rankNum} = this.state;
        return <TouchableOpacity style={styles.ShopRankCell}
                                   onPress={() => {
                                       Actions.storeDetails({...this.state});
                                   }}>
