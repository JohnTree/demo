...
export default class ForceULoginPwdT extends React.Component {
     ...
     */
    render() {
        return <View style={styles.ForceULoginPwdT}>
            <View style={styles.center}>
                ...
                <View>
                    <Text style={styles.point}>注意：由于您长时间未修改登录密码，必须先修改登录密码后才能进行其他操作。</Text>
